...
is
   ...
   begin
      ...
      --  This.Kd := Specified_Kd / Sample_Time_In_Sec;
      Temp := Long_Real (Specified_Kd) / Sample_Time_In_Sec;
      Constrain_To_Real (Temp);
      Actual_Kd := Real (Temp);
