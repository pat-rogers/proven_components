--
--  Copyright (C) 2026 Patrick Rgoers
--
...
--
--  This package has been proven free of run-time errors, including overflow
--  and underflow, in SPARK at level=2.
